...
fun SettingsGlpiUserToken() {
    ...
    val userToken = store.getUserToken.collectAsState(initial = "").value
    SettingsMenuLink(
        icon = {
            Icon(
                Icons.Default.Lock,
        ...
        title = { Text(stringResource(R.string.user_token)) },
        subtitle = { Text(userToken.ifEmpty { stringResource(R.string.not_set) }) },
    ...
    TextFieldPopup(
        header = stringResource(R.string.user_token),
        value = userToken,
